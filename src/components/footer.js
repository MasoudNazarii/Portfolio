        ...
        <>
            <footer id="Contact">
                <div className="foot-wraper">
                    ...
                    <div className="links">
                        <div className="email-wraper">
                            ...
                            <p className="p-email">masoudnazari.dev@gmail.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="footer-links">
                    ...
                    <a href="https://github.com/MasoudNazarii">SOURCE CODE</a>
                    <a href="#Home">HOME</a>
                ...
                <div className="social">
                    ...
                    <div className="linkedin wraper">
                        <a href="www.linkedin.com/in/masoud-nazarii">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width={25} 
                            height={25} 
                    ...
                    <div className="instagram wraper">
                        <a href="instagram.com">
                        <i class="bi-instagram"></i>
                        </a>
                    </div>
                    <div className="twitter wraper">
                        <a href="twitter.com">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width={25}
